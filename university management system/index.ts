...
class studentManagementSystem { 
  ...
  async addCourseToDepartment(){
    ...
    const selectedCourse :Course= getObjectFromName(this.courses,courseName)
    ...
    const selectedDepartment :Department = getObjectFromName(this.departments,departmentName)
